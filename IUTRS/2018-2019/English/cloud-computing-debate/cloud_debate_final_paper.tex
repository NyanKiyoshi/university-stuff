...
% Set the multicols figures to take the whole column width
...
\begin{Figure}
    ...
    \captionof{figure}{
        \scriptsize Electricity Consumption of the datacenters, including the power usage of manufacturing the hardware (TWh/yr) vs Growth in Core Network Traffic (including traffic within data centers), where \char`\~70\% of total traffic is between data centers.}
\end{Figure}
...
\qrcode[height=2in]{https://raw.githubusercontent.com/NyanKiyoshi/university-stuff/master/IUTRS/2018-2019/English/cloud-computing-debate/debate_project_final_paper.pdf}
