...
Il faut donner des défauts qui ne risquent pas d'affecter le travail (ex. gourmand, timide, ...). Dire qu'on est \say{trop} montrent que c'est une qualité (ex. trop curieux, trop bavard).

\subsubsection{Les questions sur le CV}
Avoir le CV en tête, le réviser, pour éviter l'oublie. Éviter une réponse trop courte.

La question classique est \say{Parlez-nous de...}, par exemple \say{Parlez nous de cette année d'étude}.
